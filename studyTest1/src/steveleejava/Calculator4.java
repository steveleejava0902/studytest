...
public class Calculator4 extends JFrame implements KeyListener {

	String KEYNUM="",OPERATION="",FIRSTNUM="",SECONDNUM="",RESULT="";
	/*
	...
	public static void main(String[] arg) {
		Calculator4 t1 = new Calculator4();
	...
	public void keyPressed(KeyEvent e) {
		...
		if(MODE == 3) {
			operationArea.setText(FIRSTNUM+OPERATION+SECONDNUM+"="+RESULT);
			MODE = 0;
			OPERATION="";
			FIRSTNUM="";
			SECONDNUM="";
